# 2026-W38 correction notice — amber-deepseek: additive correction to published scores
...
- Count for this repo in this notice: **0 standalone published cells reversed · 6 standalone published cells held** (count = standalone published cells = actual table rows).
- **Scope in one line**: 4 preview-column cells plus 2 GA cells in W37 are held; the preview endpoint is retired and cannot be re-examined, so those affected cells can only move by adjudication.
...
|---|---|---|---|---|---|
| A-ea80d793 | `1d69841b029e` | W37 | GA column ✗ -2 | held (re-exam pending) | named and removed from the board; excluded from all aggregates pending re-exam |
| A-d9b79b46 | `d6d63130ecc6` | W37 | GA column ✗ | held (re-exam pending) | same |
| A-cdc3d11a | `dbb207a3118d` | W37 | preview column ✗ -2 | held (re-exam pending) | same |
| A-ea80d793 | `1d69841b029e` | W37 | preview column ✗ -1.0 (1/5) | held (re-exam pending) | same |
| A-791e90ac | `0396c8576a56` | W37 | preview column ✗ no code | held (re-exam pending) | same |
| A-d9b79b46 | `d6d63130ecc6` | W37 | preview column ✗ | held (re-exam pending) | same |

> **Repo-specific note**: the preview endpoint is retired, so "re-exam pending" does not hold for this repo. Once adjudicated, those 4 preview-column cells can only move by **adjudication**; the 2 GA-column cells can still be re-examined. This notice lists the holds as they stand and **prejudges nothing**.
